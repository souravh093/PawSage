...
router.get('/me', (0, auth_1.default)('admin', 'user'), followers_controller_1.FollowersController.getFollowers);
router.get('/metoo', (0, auth_1.default)('admin', 'user'), followers_controller_1.FollowersController.followedUser);
