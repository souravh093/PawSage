...
const getCommentsByPostId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield comment_service_1.CommentServices.getCommentsByPostId(req.params.postId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateComment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield comment_service_1.CommentServices.updateComment(req.body, req.params.id, req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteComment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield comment_service_1.CommentServices.deleteComment(req.params.id, req.user);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
